          ...
          <div class="flex items-center gap-3">
            ...
            <NuxtLink to="/admin" class="flex items-center gap-3">
              ...
              <div class="leading-tight">
                ...
                <div class="text-xs admin-muted -mt-0.5">Manage products, services & orders</div>
              </div>
            </NuxtLink>
          </div>
      ...
      <aside class="admin-card p-3 lg:sticky lg:top-[92px] h-fit" :class="sidebarOpen ? '' : 'hidden lg:block'">
        <div class="p-2">
          ...
          <div class="mt-2 space-y-1">
            ...
            <NuxtLink to="/admin/services" class="side-link" :class="isActive('/admin/services') ? 'side-active' : ''">
              Services
            </NuxtLink>
        ...
        <div class="p-2">
          ...
          <div class="mt-2 grid grid-cols-1 gap-2">
            ...
            <NuxtLink to="/admin/services" class="btn-soft text-center">Manage Services</NuxtLink>
          </div>
        </div>
      </aside>
