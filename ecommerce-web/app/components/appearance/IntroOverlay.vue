...
watch(visible, (v) => { if (v) forcePlayIntroVideo() }, { flush: 'post' })
...
.intro-screen__video,.intro-screen__fallback{ position:absolute; inset:0; width:100%; height:100%; object-fit:cover; border:0; transform:translateZ(0); will-change:transform; }
...
.intro-screen__primary,.intro-screen__ghost{ min-height:50px; border-radius:999px; padding:0 1.25rem; font-weight:1000; transition:.2s ease; }
