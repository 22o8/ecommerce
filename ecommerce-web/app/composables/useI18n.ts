...
const dict: Record<Locale, Record<string, string>> = {
  ar: {
    ...
    loginFailed: 'فشل تسجيل الدخول. تأكد من البيانات وحاول مرة أخرى.',
      ...
      cartTotal: 'المجموع',
      cartCheckoutWhatsApp: 'إرسال الطلب عبر واتساب',
      ...
      cartWhatsAppMissing: 'رقم الواتساب غير مضبوط في إعدادات الموقع.',
      cartNote: 'ملاحظة: تأكد أن معلوماتك دقيقة حتى يتم تنفيذ الطلب بسلاسة.',

      // Register
      registerTitle: 'إنشاء حساب',
      registerSubtitle: 'أدخل معلوماتك لإنشاء حساب جديد',
      fullName: 'الاسم الكامل',
      phone: 'رقم الهاتف',
      createAccount: 'إنشاء حساب',
      haveAccount: 'لديك حساب؟ تسجيل الدخول',
      noAccount: 'ليس لديك حساب؟ أنشئ حسابًا',
      accuracyWarning: 'تنبيه: يجب أن تكون المعلومات دقيقة (الاسم + رقم الهاتف) حتى تتم عملية الشراء بسلاسة.',
...
en: {
    ...
    loginFailed: 'Login failed. Please check your details and try again.',
      ...
      cartTotal: 'Total',
      cartCheckoutWhatsApp: 'Send order on WhatsApp',
      ...
      cartGo: 'Go to cart',
      cartAdded: 'Added',
      cartWhatsAppMissing: 'WhatsApp number is not configured.',
      cartNote: 'Note: Make sure your details are accurate to complete your order smoothly.',
      ...
      accuracyWarning: 'Warning: Please provide accurate details (name + phone) to ensure smooth purchasing.',
