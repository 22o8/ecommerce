...
const dict: Record<Locale, Record<string, string>> = {
  ar: {
    ...
    cartSubtitle: 'اجمع أكثر من منتج ثم أنشئ طلباً واحداً أو أرسله عبر واتساب.',
    addToCart: 'أضف للسلة',
    addedToCart: 'تمت الإضافة',
    clearCart: 'تفريغ السلة',
    emptyCart: 'سلتك فارغة الآن.',
    orderSummary: 'ملخص الطلب',
    items: 'المنتجات',
    qty: 'الكمية',
    remove: 'حذف',
    total: 'المجموع',
    confirmOrder: 'إنشاء طلب',
    needLogin: 'لازم تسجّل دخول حتى تنشئ الطلب.',
    loginNow: 'تسجيل الدخول',
    sendWhatsApp: 'إرسال عبر واتساب',
    orderNote: 'ملاحظة: سيتم إرسال تفاصيل المنتجات المختارة للواتساب.',
    registerTitle: 'إنشاء حساب',
    registerSubtitle: 'اكتب معلوماتك بدقة حتى تتم عملية الشراء بسلاسة.',
    name: 'الاسم',
    phone: 'رقم الهاتف',
    createAccount: 'إنشاء حساب',
    haveAccount: 'عندك حساب؟ سجّل دخول',
    noAccount: 'ما عندك حساب؟ أنشئ واحد',
    accuracyWarning: 'تحذير: يجب أن تكون المعلومات دقيقة حتى تتم عملية الشراء بسلاسة.',
    services: 'الخدمات',
    myOrders: 'طلباتي',
...
en: {
    ...
    cartSubtitle: 'Collect multiple items, then create one order or send it via WhatsApp.',
    ...
    orderNote: 'Note: this will create an order in the system.',
    needLogin: 'Please login to create an order.',
    loginNow: 'Login',
    cart: 'Cart',
    cartTitle: 'Shopping Cart',
    cartSubtitle: 'Collect multiple items and place a single order or send it via WhatsApp.',
    addToCart: 'Add to cart',
    addedToCart: 'Added',
    clearCart: 'Clear cart',
    emptyCart: 'Your cart is empty.',
    ...
    needLogin: 'Please sign in to create an order.',
    loginNow: 'Login',
    sendWhatsApp: 'Send on WhatsApp',
    orderNote: 'Note: Selected items will be included in the WhatsApp message.',
    registerTitle: 'Create account',
    registerSubtitle: 'Enter accurate details to ensure smooth purchasing.',
    name: 'Name',
    phone: 'Phone',
    createAccount: 'Create account',
    haveAccount: 'Have an account? Login',
    noAccount: "Don't have an account? Create one",
    accuracyWarning: 'Warning: Please provide accurate details to ensure smooth purchasing.',
    services: 'Services',
    myOrders: 'My Orders',
