  ...
  <div class="grid gap-6 lg:grid-cols-2 lg:items-center">
    <div class="card-soft p-6 md:p-8">
      <div class="flex items-center gap-3">
        <div
          class="h-11 w-11 rounded-2xl bg-[rgb(var(--primary))] text-black dark:text-[rgb(var(--bg))] grid place-items-center"
        >
    ...
    <div class="card-soft p-6 md:p-8">
      ...
      <div class="mt-4 grid gap-3">
        <div class="rounded-3xl border border-app bg-surface p-4">
          ...
          <div class="text-sm text-muted rtl-text mt-1">
            {{ t('benefit.orders.desc') }}
          </div>
        </div>
